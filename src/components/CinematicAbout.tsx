  ...
  return (
    <section ref={sectionRef} id="about" className="py-12 bg-gradient-subtle relative overflow-hidden"
      ...
      <div className={`absolute top-10 left-10 w-64 h-64 bg-primary/5 rounded-full blur-3xl opacity-50 transition-all duration-1000 ${
        isVisible('about-section') ? 'animate-morph' : ''
      }`} />
            ...
            {training.map((item, index) => (
              <Card 
                ...
                className={`bg-card border-border hover:border-primary/30 transition-all duration-700 group hover:animate-card-hover-3d hover:shadow-dramatic ${
                  visibleTraining.has(index) || isVisible('about-section') ? 'animate-bounceIn opacity-100' : 'opacity-0 scale-75'
                }`}
          ...
          <div className="grid md:grid-cols-2 gap-6">
            {awards.map((award, index) => (
              <Card 
                key={index} 
                className={`bg-card border-border hover:border-primary/30 transition-all duration-700 group hover:animate-card-hover-3d hover:shadow-dramatic ${
                  visibleAwards.has(index) || isVisible('about-section') ? 'animate-slide-3d-left opacity-100' : 'opacity-0 translate-x-20'
                }`}
